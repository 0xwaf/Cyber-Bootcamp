...
from scapy.packet import bind_layers # type: ignore
# Custom imports
import pysap
from pysap.SAPNI import SAPNI # type: ignore
from pysap.SAPRouter import (SAPRouter, SAPRouteException, # type: ignore
...
def parse_options():
    ...
    description = "This example script routes a connection through a SAP Router service."
